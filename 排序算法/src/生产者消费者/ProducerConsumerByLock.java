...
public class ProducerConsumerByLock {
    ...
    public static void main(String args[]){
        ...
        Thread producer1 = new Producer("生产者-1", queue, CAPACITY);
        Thread producer2 = new Producer("生产者-2", queue, CAPACITY);
        Thread consumer1 = new Consumer("消费者-1", queue, CAPACITY);
        Thread consumer2 = new Consumer("消费者-2", queue, CAPACITY);
        Thread consumer3 = new Consumer("消费者-3", queue, CAPACITY);
